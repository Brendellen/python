...
def cadastra_produto():
    ...
    produto_preco=st.number_input("Preco",min_value=0.0, step=1.00)
    produto_estoque=st.number_input('Estoque',min_value=0)

    if st.button('Cadastrar Produto'):
        # Criar um novo DataFrame para o novo produto
...
if __name__ =="__main__":
    ...
    opcao= st.sidebar.selectbox("Escolha um opção",['Cadastrar Produto','Alterar Produto','Apagar Produto',"Listar Todos os Produtos"])
